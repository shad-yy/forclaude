...
const mockUpcomingEvents: UFCEvent[] = [
  {
    ...
    status: "Upcoming",
    image: "/ufc-310-poster.png",
    mainEvent: "Alexandre Pantoja vs Kai Asakura",
    fights: [
      {
        id: "main-310",
        fighter1: { name: "Alexandre Pantoja" },
        fighter2: { name: "Kai Asakura" },
      ...
      {
        id: "co-main-310",
        fighter1: { name: "Shavkat Rakhmonov" },
        fighter2: { name: "Ian Machado Garry" },
      ...
      {
        id: "fight-310-3",
        fighter1: { name: "Ciryl Gane" },
        fighter2: { name: "Alexander Volkov" },
  ...
  },
  {
    ...
    status: "Upcoming",
    image: "/ufc-311-poster.png",
    mainEvent: "Islam Makhachev vs Renato Moicano",
    fights: [
      {
        id: "main-311",
        fighter1: { name: "Islam Makhachev" },
        fighter2: { name: "Renato Moicano" },
        weightClass: "Lightweight Title",
        isMainEvent: true,
        isTitleFight: true,
        cardSegment: "Main Card",
      },
      {
        id: "co-main-311",
        fighter1: { name: "Merab Dvalishvili" },
        fighter2: { name: "Umar Nurmagomedov" },
...
const mockPastEvents: UFCEvent[] = [
  {
    ...
    fights: [
      {
        id: "main-309",
        fighter1: { name: "Jon Jones" },
        fighter2: { name: "Stipe Miocic" },
      ...
      {
        id: "co-main-309",
        fighter1: { name: "Charles Oliveira" },
        fighter2: { name: "Michael Chandler" },
  ...
  },
  {
    ...
    mainEvent: "Ilia Topuria vs Max Holloway",
    fights: [
      {
        id: "main-308",
        fighter1: { name: "Ilia Topuria" },
        fighter2: { name: "Max Holloway" },
        weightClass: "Featherweight Title",
        isMainEvent: true,
        isTitleFight: true,
        cardSegment: "Main Card",
      },
