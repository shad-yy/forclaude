...
const QUICK_LINKS = [
  ...
  { href: '/buy', label: 'Subscribe' },
  { href: '/channels', label: '230K+ Channels' },
  { href: '/setup/firestick', label: 'Firestick Setup' },
  { href: '/setup/smart-tv', label: 'Smart TV Setup' },
  { href: '/iptv-vs-sky-sports', label: 'IPTV vs Sky Sports' },
  { href: '/blog/is-iptv-legal-uk', label: 'Is IPTV Legal?' },
  { href: '/faq', label: 'FAQ' },
