        ...
        <div className="bg-gradient-to-br from-[#1a1a28] to-[#12121d] border border-[#2a2a3e] rounded-2xl p-6 flex flex-col justify-between shadow-lg">
          <div>
            ...
            <p className="text-xs text-gray-300 leading-relaxed mb-6">
              ...
              international broadcasts are fully integrated.
            </p>
          </div>
          <Link
            href="/buy"
          ...
          >
            Get Instant Stream <ExternalLink className="w-4 h-4" />
          </Link>
        </div>
      </div>
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-4 bg-white/5 p-3 rounded-xl border border-white/5">
        {teamBadge && <img src={teamBadge} alt="" className="w-8 h-8 object-contain" />}
