...
export const metadata: Metadata = {
  ...
  description:
    "Subscribe to Smart Live TV for premium sports content, exclusive analysis, and real-time notifications.",
  keywords: "sports subscription, premium sports content, live scores, sports news",
}
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Check out our FAQ or contact our support team for help with your subscription.
        </p>
