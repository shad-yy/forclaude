...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/iptv-vs-netflix`, priority: 0.9, changeFrequency: 'monthly' as const, lastModified: now },
    ...
    { url: `${baseUrl}/watch/world-cup-2026`, priority: 0.3, changeFrequency: 'yearly' as const, lastModified: now },
    ...
    { url: `${baseUrl}/scores`, priority: 0.9, changeFrequency: 'daily' as const, lastModified: now },
    { url: `${baseUrl}/events`, priority: 0.8, changeFrequency: 'daily' as const, lastModified: now },
    { url: `${baseUrl}/leagues`, priority: 0.8, changeFrequency: 'weekly' as const, lastModified: now },
    { url: `${baseUrl}/teams`, priority: 0.7, changeFrequency: 'weekly' as const, lastModified: now },
