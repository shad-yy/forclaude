...
export const metadata: Metadata = {
  title: 'IPTV vs Sky Sports UK (2026) — Honest Side-by-Side Comparison',
  description: 'Sky Sports costs £43/month. Smart Live TV costs £12 and includes every Sky Sports channel plus Netflix, Disney+ and 230,000+ more. Full comparison.',
  alternates: {
...
const faqs = [
  {
    q: "Does Smart Live TV include all Sky Sports channels?",
    a: "Yes. Smart Live TV includes all Sky Sports channels (Main Event, Premier League, Football, F1, Cricket, Golf, Arena, Action, News, Racing, and Mix) in high-definition and ultra-HD. You receive the exact same matchday feeds as a traditional subscription."
  },
  {
    q: "Can I cancel Sky Sports and use IPTV instead?",
    a: "Yes. You can cancel your Sky Sports pack or your entire Sky contract and switch to Smart Live TV. Because we have zero contracts, we recommend running our free 24-hour trial first to confirm everything works flawlessly on your device."
  },
  {
    q: "Is IPTV better quality than Sky Sports?",
    a: "Our streams run on premium 60FPS servers optimized for high-speed sports action, matching or exceeding the standard HD/4K resolution of Sky Sports. In addition, you get access to all global feeds (including 3pm blackout matches not broadcast in the UK)."
  },
  {
    q: "Do I need Sky broadband to use Smart Live TV?",
    a: "No. Smart Live TV works perfectly with any UK internet service provider (BT, Virgin Media, Sky, EE, TalkTalk, Community Fibre, etc.). It does not require a specific provider or setup."
  },
  {
    q: "What's the cheapest way to watch Sky Sports?",
    a: "Directly subscribing to Sky Sports costs upwards of £43/month. Choosing Smart Live TV starting from £12/month is the most cost-effective solution, giving you all Sky channels, TNT Sports, and major VOD platforms in one single package."
  },
  {
    q: "Is it legal to use IPTV instead of Sky Sports in the UK?",
    a: "While rights holders advocate for official channels, private IPTV services offer UK viewers a consumer-friendly alternative to skyrocketing subscription packages. We prioritize user privacy and safety, meaning we never log, track, or share your stream activity."
  }
]
...
export default function IptvVsSkySportsPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'IPTV vs Sky Sports', item: `${ENV.BASE_URL}/iptv-vs-sky-sports` },
    ],
  }
      ...
      <section className="pt-28 md:pt-36 pb-16 px-4 text-center border-b border-[#2a2a3a]"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
            IPTV vs Sky Sports<br/>
            <span className="text-[#00e676]">
              Which Is Better Value in 2026?
            </span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-8">
            Sky Sports costs £43/month. Smart Live TV includes every Sky Sports channel for £12/month — plus Netflix, Disney+ and 230,000 other channels.
          </p>
